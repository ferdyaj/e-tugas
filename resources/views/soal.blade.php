...
id="exampleModalLabel">Update Tugas</h1>
...
readonly class="form-control" value="{{ $s->idsoal }}">
<div class="form-floating">
<label for="floatingInputValue">Judul Materi</label>

<input type="text" name="judulmateri"
required="required" class="form-control" value="{{ $s->judulmateri }}">
...
<br>
<textarea name="deskripsisoal" id=""

cols="50" rows="10">{{ $s->deskripsisoal }}</textarea>
...
id="exampleModalLabel">Kerjakan Tugas</h1>
...
<div class="form-floating">
<p>Deskripsi Tugas : {{ $s->deskripsisoal
...
<div class="modal-header">
<h1 class="modal-title fs-5"
id="exampleModalLabel">Tambah Tugas</h1>

</div>
<div class="modal-body">
<form action="/soal/storeinput" method="post"
