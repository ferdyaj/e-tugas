...
<style>
    ...
    .navbar-nav>li>a:hover {
        background-color: #0056b3; /* Navbar link hover background color */
    }
    ...
    .dropdown-menu>li>a {
        color: #ffffff !important; /* Dropdown menu link text color */
    }

    .dropdown-menu>li>a:hover {
        background-color: #0056b3; /* Dropdown menu link hover background color */
    }
...
href="{{route('actionlogout')}}"><i class="fa fa-power-off"></i> LogOut</a></li>
